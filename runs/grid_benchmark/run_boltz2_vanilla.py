...
def _(Path, os):
    ...
    RESULTS_FILE = ROOT_DIR / "results" / "boltz2_vanila_benchmark_results.jsonl"
    OUT_DIR_BASE = ROOT_DIR / "boltz2_vanila_benchmark"
...
def _(RESULTS_FILE, load_completed, param_grid):
    ...
    print(f"Number of combinations to check: {len(all_params)}")
